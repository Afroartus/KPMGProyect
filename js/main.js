// importScripts("datos.js", datosJS);

var tableUno    =   [["Incidente",     "Accesos",          "Bloqueo Contraseña"],
...
var tableTres   =   [["Incidente",     "Computador",    "Bloqueo y/o Falla PC"],
...
var tableCinco =    [["Requerimiento Interno",  "Suministros",      "Compra" ],
...
let table = new DataTable('#tabla-one-hour', {
    lengthChange: false,
    processing: false,
    ordenig: false,
    searching: true,
